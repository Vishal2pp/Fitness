...
<!--==========================
  ...
  <main id="main">
<center><h2>Expired Members List</h2></center>
  ...
  <td>
  	<button type="button" class="btn btn-info" id="${member.id}" data-toggle="modal" data-target="#myModal" onclick="clickedMe('${member.id}')">Details</button>
  	<button type="button" class="btn btn-info" id="${member.id}" data-toggle="modal" data-target="#myModal" onclick="clickedMeRenew('${member.id}')">Renew</button>
  </td>
  </tr>
  </c:forEach>
  <tbody>
